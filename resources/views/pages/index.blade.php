...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top"> <i class="fa fa-play-circle"></i> <span class="light">Dealer</span> Inspire Challenge </a>
            </div>
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li> <a class="page-scroll" href="#coffee">Coffee</a> </li>
    ...
    <header class="intro">
        <div class="intro-body">
            <div class="container">
                <div class="row">
                    <!-- Errors -->@if ($errors->has('full_name'))
                    <div class="alert alert-danger"> {{ $errors->first('full_name') }} </div> @endif @if ($errors->has('email'))
                    <div class="alert alert-danger"> {{ $errors->first('email') }} </div> @endif @if ($errors->has('phone'))
                    <div class="alert alert-danger"> {{ $errors->first('phone') }} </div> @endif @if ($errors->has('comments'))
                    <div class="alert alert-danger"> {{ $errors->first('comments') }} </div> @endif
                    <!-- Intro Header -->
    ...
    <section id="coffee" class="content-section text-center">
        <div class="download-section">
            <div class="container">
                <div class="col-lg-8 col-lg-offset-2">
                    <h2>Coffee Break?</h2>
                    <p>Take a coffee break. You deserve it.</p> <a href="https://www.youtube.com/dealerinspire" class="btn btn-default btn-lg">or Watch YouTube</a> </div>
            </div>
        </div>
    </section>
    <!-- Contact Section -->
    <a name="gotoform"></a>
    <!-- Anchored here for Successful form post message -->
        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <p class="bg-primary">
                    ...
                    <!-- This is the Successful form post message -->@if(Session::has('success'))
                    <div class="alert alert-success"> {{Session::get('success')}} </div> @endif
                    <form method="post" action="postcontact"> @csrf
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <!-- Error -->@if ($errors->has('full_name'))
                                <div class="alert-danger"> {{ $errors->first('full_name') }} </div> @endif </div>
                            <div class="col-md-6 form-group">
                                ...
                                <!-- Error -->@if ($errors->has('email'))
                                <div class="alert-danger"> {{ $errors->first('email') }} </div> @endif </div>
                            <div class="col-md-6 form-group">
                                ...
                                <!-- Error -->@if ($errors->has('phone'))
                                <div class="alert-danger"> {{ $errors->first('phone') }} </div> @endif </div>
                            <!-- honeypot -->
                            <div class="form-group row" style="display: none;">
                                <input type="checkbox" name="faxonly" id="faxonly" /> </div>
                            <!-- end honeypot -->
                            <div class="col-md-12 form-group">
                                <textarea class="form-control" maxlength="1000" name="comments" aria-label="Comments" placeholder="Comments">{{old('comments')}}</textarea>
                                <!-- Error -->@if ($errors->has('comments'))
                                <div class="alert-danger"> {{ $errors->first('comments') }} </div> @endif </div>
